...
public class MainProgram {
	...
	public static void InitGUI(){
		...
		System.out.println("Author: Bach Quoc Dong");
		System.out.println("Major: BSc. Computer Science");
		System.out.println("Class: 2018-2020");
		System.out.println("Institution: Eotvos Lorand University");
		System.out.println("Email: bachquocdong91@gmail.com");
		System.out.println("Website: ");
		System.out.println("Copyright ©2013-2016. All rights reserved.");
		
		frame = new JFrame();
		frame.setTitle("Caro 3.0 - Bach Quoc Dong");
